...
- [ ] Confirm the view course details scope against the referenced PRD, architecture, UX, and epic requirements.
...
- Story 3.2 where its output is required by this story
...
- `docs/planning-artifacts/epics.md` — Story 3.3 and Epic 3
...
- `docs/implementation-artifacts/sprint-status.yaml` — story tracking key `3-3-view-course-details`
