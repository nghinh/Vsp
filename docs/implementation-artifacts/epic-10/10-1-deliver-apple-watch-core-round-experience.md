...
story: "10.1"
epic: 10
title: "Deliver Apple Watch Core Round Experience"
status: done
phase: "MVP 2–3"
...
- [ ] Confirm the deliver apple watch core round experience scope against the referenced PRD, architecture, UX, and epic requirements.
...
- `docs/planning-artifacts/epics.md` — Story 10.1 and Epic 10
...
- `docs/implementation-artifacts/sprint-status.yaml` — story tracking key `10-1-deliver-apple-watch-core-round-experience`
