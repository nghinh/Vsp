...
story: "10.4"
epic: 10
title: "Detect Shots with Confidence"
status: done
phase: "MVP 2–3"
...
- [ ] Confirm the detect shots with confidence scope against the referenced PRD, architecture, UX, and epic requirements.
...
- Story 10.3 where its output is required by this story
...
- `docs/planning-artifacts/epics.md` — Story 10.4 and Epic 10
...
- `docs/implementation-artifacts/sprint-status.yaml` — story tracking key `10-4-detect-shots-with-confidence`
