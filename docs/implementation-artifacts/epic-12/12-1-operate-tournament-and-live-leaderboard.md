...
story: "12.1"
epic: 12
title: "Operate Tournament and Live Leaderboard"
status: done
phase: "MVP 4"
...
- [ ] Confirm the operate tournament and live leaderboard scope against the referenced PRD, architecture, UX, and epic requirements.
...
- `docs/planning-artifacts/epics.md` — Story 12.1 and Epic 12
...
- `docs/implementation-artifacts/sprint-status.yaml` — story tracking key `12-1-operate-tournament-and-live-leaderboard`
