...
story: "7.4"
epic: 7
title: "Enforce Tournament Mode Restrictions"
status: done
phase: "MVP 1"
...
- [ ] Confirm the enforce tournament mode restrictions scope against the referenced PRD, architecture, UX, and epic requirements.
...
- Story 7.3 where its output is required by this story
...
- `docs/planning-artifacts/epics.md` — Story 7.4 and Epic 7
...
- `docs/implementation-artifacts/sprint-status.yaml` — story tracking key `7-4-enforce-tournament-mode-restrictions`
