...
story: "7.3"
epic: 7
title: "Display Official Pin and Course Conditions"
status: done
phase: "MVP 1"
...
- [ ] Confirm the display official pin and course conditions scope against the referenced PRD, architecture, UX, and epic requirements.
...
- Story 7.2 where its output is required by this story
...
- `docs/planning-artifacts/epics.md` — Story 7.3 and Epic 7
...
- `docs/implementation-artifacts/sprint-status.yaml` — story tracking key `7-3-display-official-pin-and-course-conditions`
