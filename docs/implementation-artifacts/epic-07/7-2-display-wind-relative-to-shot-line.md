...
story: "7.2"
epic: 7
title: "Display Wind Relative to Shot Line"
status: done
phase: "MVP 1"
...
- [ ] Confirm the display wind relative to shot line scope against the referenced PRD, architecture, UX, and epic requirements.
...
- Story 7.1 where its output is required by this story
...
- `docs/planning-artifacts/epics.md` — Story 7.2 and Epic 7
...
- `docs/implementation-artifacts/sprint-status.yaml` — story tracking key `7-2-display-wind-relative-to-shot-line`
