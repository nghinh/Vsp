...
- [ ] Confirm the establish backend modular monolith scope against the referenced PRD, architecture, UX, and epic requirements.
...
- Story 1.1 where its output is required by this story
...
- `docs/planning-artifacts/epics.md` — Story 1.2 and Epic 1
...
- `docs/implementation-artifacts/sprint-status.yaml` — story tracking key `1-2-establish-backend-modular-monolith`
