...
story: "4.3"
epic: 4
title: "Download and Manage Offline Courses"
status: done
phase: "MVP 1"
...
- [ ] Confirm the download and manage offline courses scope against the referenced PRD, architecture, UX, and epic requirements.
...
- Story 4.2 where its output is required by this story
...
- `docs/planning-artifacts/epics.md` — Story 4.3 and Epic 4
...
- `docs/implementation-artifacts/sprint-status.yaml` — story tracking key `4-3-download-and-manage-offline-courses`
