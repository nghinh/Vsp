...
story: "4.2"
epic: 4
title: "Generate and Publish Course Packages"
status: done
phase: "MVP 1"
...
- [ ] Confirm the generate and publish course packages scope against the referenced PRD, architecture, UX, and epic requirements.
...
- Story 4.1 where its output is required by this story
...
- `docs/planning-artifacts/epics.md` — Story 4.2 and Epic 4
...
- `docs/implementation-artifacts/sprint-status.yaml` — story tracking key `4-2-generate-and-publish-course-packages`
