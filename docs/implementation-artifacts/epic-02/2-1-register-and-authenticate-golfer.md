...
story: "2.1"
epic: 2
title: "Register and Authenticate Golfer"
status: in-progress
phase: "MVP 1"
...
- [ ] Confirm the register and authenticate golfer scope against the referenced PRD, architecture, UX, and epic requirements.
...
- `docs/planning-artifacts/epics.md` — Story 2.1 and Epic 2
...
- `docs/implementation-artifacts/sprint-status.yaml` — story tracking key `2-1-register-and-authenticate-golfer`
