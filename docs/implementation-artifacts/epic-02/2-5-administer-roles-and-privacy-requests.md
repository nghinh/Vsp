...
story: "2.5"
epic: 2
title: "Administer Roles and Privacy Requests"
status: done
phase: "MVP 1"
...
- [ ] Confirm the administer roles and privacy requests scope against the referenced PRD, architecture, UX, and epic requirements.
...
- Story 2.4 where its output is required by this story
...
- `docs/planning-artifacts/epics.md` — Story 2.5 and Epic 2
...
- `docs/implementation-artifacts/sprint-status.yaml` — story tracking key `2-5-administer-roles-and-privacy-requests`
