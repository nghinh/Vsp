...
- [x] Confirm the detect course and hole scope against the referenced PRD, architecture, UX, and epic requirements.
...
- Story 6.1 where its output is required by this story
...
- `docs/planning-artifacts/epics.md` — Story 6.2 and Epic 6
...
- `docs/implementation-artifacts/sprint-status.yaml` — story tracking key `6-2-detect-course-and-hole`
