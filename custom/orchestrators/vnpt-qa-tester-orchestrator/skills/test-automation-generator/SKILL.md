# Skill: test-automation-generator

## Purpose

Generates runnable unit/component/integration/API/property/E2E tests from the approved test plan and oracle.
...
3. generate tests with business assertions.
4. generate fixtures.
5. avoid mocking core behavior under test.
6. include commands.
7. map test IDs to files.
