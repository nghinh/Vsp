# Skill: coverage-gap-analyzer

## Purpose

Compares requirements, risks, states, APIs, and code areas against existing/generated tests to find coverage gaps.

## Required outputs

- `coverage-gap section in 10-quality-gate-report.md`

## Procedure

1. map requirements to tests.
2. map risks to tests.
3. map states/transitions to tests.
4. identify untested files/branches.
5. identify shallow assertions.
6. recommend missing tests.
