# Skill: e2e-test-designer

## Purpose

Designs Playwright E2E tests from QA intent, not blind UI recording.

## Required outputs

- `Playwright spec files`
- `E2E test plan section in automation map`

## Procedure

1. start from risk and oracle.
2. cover critical user journeys.
3. include validation and disabled states.
4. verify backend-visible side effects if possible.
5. avoid fragile selectors.
6. include trace/screenshot on failure.
