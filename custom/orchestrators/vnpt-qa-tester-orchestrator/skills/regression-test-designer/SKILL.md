# Skill: regression-test-designer

## Purpose

Creates regression tests from known bugs, recently changed files, TODO/FIXME hotspots, and bug fix briefs.
...
1. mine known bugs.
2. inspect recent changes if available.
3. turn each bug into reproducer.
4. ensure bug cannot reappear.
5. tag regression tests with bug IDs.
