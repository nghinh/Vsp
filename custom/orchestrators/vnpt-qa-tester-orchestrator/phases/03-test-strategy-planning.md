# Phase: 03-test-strategy-planning

## Purpose

Route each risk to one or more strategies: example, combinatorial, state-machine, property, API fuzz, E2E, exploratory, mutation, regression.
...
- fallback when tool missing
- priority order

## Required output

`docs/qa/<feature>/03-test-strategy.md`
