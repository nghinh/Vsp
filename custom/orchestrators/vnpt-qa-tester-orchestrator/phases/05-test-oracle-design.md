...
Define expected/forbidden behavior and assertion strategy for every test.
...
`docs/qa/<feature>/05-test-oracle.md`
...
- source of truth: requirement/story/API spec/code contract/domain rule
...
Automation may only reference oracle IDs that exist in `05-test-oracle.md`.
