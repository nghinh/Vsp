...
| Guide | File |
|-------|------|
| Budgets & Optimization | [`references/flutter-performance.md`](references/flutter-performance.md) |
| Code Examples | [`examples/performance_examples.dart`](examples/performance_examples.dart) |
...
| Guide | File |
|-------|------|
| Architecture & Sync | [`references/flutter-offline-guide.md`](references/flutter-offline-guide.md) |
| Code Examples | [`examples/offline_examples.dart`](examples/offline_examples.dart) |
...
| Guide | File |
|-------|------|
| iOS/Android/Channels | [`references/flutter-platform-guide.md`](references/flutter-platform-guide.md) |
| Code Examples | [`examples/platform_examples.dart`](examples/platform_examples.dart) |

**Key Points:**
- iOS: CupertinoWidget, HIG compliance
...
| Guide | File |
|-------|------|
| Unit/Widget/Integration | [`references/flutter-testing-guide.md`](references/flutter-testing-guide.md) |
| Code Examples | [`examples/testing_examples.dart`](examples/testing_examples.dart) |
...
| Guide | File |
|-------|------|
| DevTools & Techniques | [`references/flutter-debugging.md`](references/flutter-debugging.md) |
...
### References
- `references/flutter-debugging.md` - Debugging guide
- `references/flutter-performance.md` - Performance optimization
- `references/flutter-offline-guide.md` - Offline-first architecture
- `references/flutter-platform-guide.md` - Platform integration
- `references/flutter-testing-guide.md` - Testing strategies

### Examples
- `examples/performance_examples.dart` - Performance patterns
- `examples/offline_examples.dart` - Offline patterns
- `examples/platform_examples.dart` - Platform patterns
- `examples/testing_examples.dart` - Testing patterns
