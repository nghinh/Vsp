...
class TournamentPolicyLocalCache {
  ...
  TournamentPolicy _fromMap(Map<String, dynamic> map) {
    return TournamentPolicy(
      ...
      windAdjustmentEnabled: (map['wind_adjustment_enabled'] as int) == 1,
      playsLikeEnabled: (map['plays_like_enabled'] as int) == 1,
      elevationEnabled: (map['elevation_enabled'] as int) == 1,
      clubRecommendationEnabled:
          (map['club_recommendation_enabled'] as int) == 1,
      contoursEnabled: (map['contours_enabled'] as int) == 1,
      puttingHelpEnabled: (map['putting_help_enabled'] as int) == 1,
      aiFeaturesEnabled: (map['ai_features_enabled'] as int) == 1,
