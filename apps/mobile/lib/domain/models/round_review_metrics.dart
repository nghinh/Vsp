...
class RoundScoringSummary extends Equatable {
  ...
  factory RoundScoringSummary.fromJson(Map<String, dynamic> json) {
    return RoundScoringSummary(
      ...
      totalGrossScore: json['totalGrossScore'] as int,
      totalPutts: json['totalPutts'] as int?,
      totalPenalties: json['totalPenalties'] as int?,
      girCount: json['girCount'] as int?,
      girTotal: json['girTotal'] as int?,
      firCount: json['firCount'] as int?,
      firTotal: json['firTotal'] as int?,
      upAndDownCount: json['upAndDownCount'] as int?,
      upAndDownTotal: json['upAndDownTotal'] as int?,
      sandSaveCount: json['sandSaveCount'] as int?,
      sandSaveTotal: json['sandSaveTotal'] as int?,
      birdieOrBetterCount: json['birdieOrBetterCount'] as int?,
      parOrBetterCount: json['parOrBetterCount'] as int?,
      bogeyOrWorseCount: json['bogeyOrWorseCount'] as int?,
