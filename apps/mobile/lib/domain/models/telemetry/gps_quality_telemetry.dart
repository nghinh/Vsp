...
class GpsQualityTelemetry extends Equatable {
  ...
  factory GpsQualityTelemetry.fromMap(Map<String, dynamic> map) {
    return GpsQualityTelemetry(
      ...
      horizontalAccuracyMeters: map['horizontal_accuracy_meters'] as double,
      verticalAccuracyMeters: map['vertical_accuracy_meters'] as double?,
      fixQuality: GpsFixQualityDto.fromString(
        map['fix_quality'] as String? ?? 'unknown',
      ),
      speedMetersPerSecond: map['speed_meters_per_second'] as double?,
      headingDegrees: map['heading_degrees'] as double?,
      isStale: (map['is_stale'] as int) == 1,
