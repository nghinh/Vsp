...
.metric-card--neutral { border-color: #2d3449; }
...
.stale-table th {
  ...
  border-bottom: 2px solid #2d3449;
  background: #171f33;
}
.stale-table td {
  padding: 0.75rem 1rem;
...
.stale-table tr:hover td { background: #171f33; }
...
.badge-pin            { color: #ec6a06; background: #222a3d; }
